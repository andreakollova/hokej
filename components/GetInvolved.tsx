...
export const GetInvolved: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        {roles.map((role, index) => (
          ...
          >
            ...
            {/* Gradient Overlay - Blue (Light from bottom) */}
      ...
      {/* Banner */}
      <div className="relative rounded-[32px] p-8 md:p-12 overflow-hidden shadow-2xl group border border-blue-900/10">
         ...
         {/* Animated blobs - Blue tones only */}
