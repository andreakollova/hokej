  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-6 gap-6">
         ...
         <button className="hidden md:flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-slovak-blue transition-colors bg-white px-4 py-2 rounded-full border border-gray-100 shadow-sm mt-auto">
        ...
        <div className="flex flex-col gap-12 animate-in fade-in duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-8">
            ...
            <div className="lg:col-span-4 flex flex-col h-full">
              <div className="bg-white rounded-xl p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 h-full flex flex-col justify-between">
